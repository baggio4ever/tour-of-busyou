  ...
  createDb() {
    let busyous = [
      { id:1, name:'上杉謙信',kana:'うえすぎ けんしん',
        param_buryoku:100,param_seiji:50,param_chibou:70,
        img:'00005_m.jpg' },
      { id:2, name:'織田信長',kana:'おだ のぶなが',
        param_buryoku:80,param_seiji:70,param_chibou:70,
        img:'00001_m.jpg' },
      { id:3, name:'豊臣秀吉',kana:'とよとみ ひでよし',
        param_buryoku:70,param_seiji:80,param_chibou:80,
        img:'00002_m.jpg' },
      { id:4, name:'徳川家康',kana:'とくがわ いえやす',
        param_buryoku:80,param_seiji:90,param_chibou:80,
        img:'00003_m.jpg' },
      { id:5, name:'武田信玄',kana:'たけだ しんげん',
        param_buryoku:90,param_seiji:80,param_chibou:90,
        img:'00004_m.jpg' },
      { id:6, name:'北条氏康',kana:'ほうじょう うじやす',
        param_buryoku:80,param_seiji:85,param_chibou:90,
        img:'00036_m.jpg' },
      { id:7, name:'今川義元',kana:'いまがわ よしもと',
        param_buryoku:83,param_seiji:88,param_chibou:80,
        img:'00016_m.jpg' },
      { id:8, name:'浅井長政',kana:'あざい ながまさ',
        param_buryoku:85,param_seiji:60,param_chibou:60,
        img:'00018_m.jpg' },
