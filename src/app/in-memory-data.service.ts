...
//      { id:26, name:'徳川家茂',img:'' },
      ...
      { id:38, name:'大谷吉継',kana:'おおたに よしつぐ',img:'00043_m.jpg' },
      { id:37, name:'加藤清正',kana:'かとう きよまさ',img:'00033_m.jpg' },
      { id:38, name:'立花宗茂',kana:'たちばな むねしげ',img:'00035_m.jpg' },
      { id:39, name:'福島正則',kana:'ふくしま まさのり',img:'00039_m.jpg' },
      { id:40, name:'佐竹義重',kana:'さたけ よししげ',img:'00053_m.jpg' },
      { id:41, name:'井伊直政',kana:'いい なおまさ',img:'00105_m.jpg' },
      { id:42, name:'榊原康政',kana:'さかきはら やすまさ',img:'00104_m.jpg' },
      { id:43, name:'宇佐美定満',kana:'うさみ さだみつ',img:'00227_m.jpg' },
      { id:44, name:'立花道雪',kana:'たちばな どうせつ',img:'00191_m.jpg' },
    ];
